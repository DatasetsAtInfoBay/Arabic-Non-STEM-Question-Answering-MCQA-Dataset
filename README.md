...
This dataset is a large-scale collection of **Arabic Non-STEM Question Answering (QA)** data in MCQA format, designed to support the development of advanced NLP systems and AI models for general knowledge understanding and reasoning in Arabic.
